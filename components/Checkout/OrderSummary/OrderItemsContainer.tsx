    ...
    <Grid container className={"py-2 px-2 has-background-white br-lg mb-4"}>
      ...
      <Grid container item xs={10} justifyContent="center" alignItems="center">
        <Grid item xs={8}>
          ...
          <p className="has-text-weight-semibold mr-2 is-size-5">{providerData?.full_name}</p>
        ...
        <Grid item xs={4}>
          <Stack
            ...
            <p className={Styles.discountedPrice}>{bookingDetail?.startTime} - {bookingDetail?.endTime}</p>
            <p className="text-light is-size-6 ">{bookingDetail?.noOfHours} hrs</p>
          </Stack>
        </Grid>
      </Grid>
    </Grid>
